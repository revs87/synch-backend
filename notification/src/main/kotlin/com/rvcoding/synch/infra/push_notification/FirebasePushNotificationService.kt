package com.rvcoding.synch.infra.push_notification
...
import com.rvcoding.synch.domain.model.PushNotificationSendResult
...
class FirebasePushNotificationService(
    ...
    @param:Value("\${firebase.client-package-name}")
                        ...
                        DeviceToken.Platform.ANDROID -> {
                            setAndroidConfig(
                                AndroidConfig.builder()
                                    ...
                                    .setRestrictedPackageName(clientPackageName)
                                    .build()
                            )
                        }
